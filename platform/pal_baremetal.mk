...
RME_ROOT:= $(RME_PATH)
RME_DIR := $(RME_ROOT)/platform/pal_baremetal/src/
RME_A64_DIR := $(RME_ROOT)/platform/pal_baremetal/src/AArch64/
FVP_DIR  := $(RME_ROOT)/platform/pal_baremetal/FVP/src/

CFLAGS    += -I$(RME_ROOT)/
CFLAGS    += -I$(RME_ROOT)/val/include/
CFLAGS    += -I$(RME_ROOT)/platform/pal_baremetal/
CFLAGS    += -I$(RME_ROOT)/platform/pal_baremetal/FVP/
CFLAGS    += -I$(RME_ROOT)/platform/pal_baremetal/FVP/include/
ASFLAGS   += -I$(RME_ROOT)/platform/pal_baremetal/src/AArch64/
...
DEPS += $(RME_ROOT)/val/include/pal_interface.h

FILES   += $(foreach files,$(RME_DIR)/,$(wildcard $(files)/*.S))
