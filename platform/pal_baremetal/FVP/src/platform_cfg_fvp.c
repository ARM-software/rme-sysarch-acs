...
PCIE_READ_TABLE platform_pcie_device_hierarchy = {
    ...
    .device[21].class_code    = PLATFORM_PCIE_DEV21_CLASSCODE,
    .device[21].vendor_id     = PLATFORM_PCIE_DEV21_VENDOR_ID,
    .device[21].device_id     = PLATFORM_PCIE_DEV21_DEV_ID,
    .device[21].bus           = PLATFORM_PCIE_DEV21_BUS_NUM,
    .device[21].dev           = PLATFORM_PCIE_DEV21_DEV_NUM,
    .device[21].func          = PLATFORM_PCIE_DEV21_FUNC_NUM,
    .device[21].seg           = PLATFORM_PCIE_DEV21_SEG_NUM,
    .device[21].dma_support   = PLATFORM_PCIE_DEV21_DMA_SUPPORT,
    .device[21].dma_coherent  = PLATFORM_PCIE_DEV21_DMA_COHERENT,
    .device[21].p2p_support   = PLATFORM_PCIE_DEV21_P2P_SUPPORT,
    .device[21].dma_64bit     = PLATFORM_PCIE_DEV21_DMA_64BIT,
    .device[21].behind_smmu   = PLATFORM_PCIE_DEV21_BEHIND_SMMU,
    .device[21].atc_present   = PLATFORM_PCIE_DEV21_ATC_SUPPORT,

    .device[22].class_code    = PLATFORM_PCIE_DEV22_CLASSCODE,
    .device[22].vendor_id     = PLATFORM_PCIE_DEV22_VENDOR_ID,
    .device[22].device_id     = PLATFORM_PCIE_DEV22_DEV_ID,
    .device[22].bus           = PLATFORM_PCIE_DEV22_BUS_NUM,
    .device[22].dev           = PLATFORM_PCIE_DEV22_DEV_NUM,
    .device[22].func          = PLATFORM_PCIE_DEV22_FUNC_NUM,
    .device[22].seg           = PLATFORM_PCIE_DEV22_SEG_NUM,
    .device[22].dma_support   = PLATFORM_PCIE_DEV22_DMA_SUPPORT,
    .device[22].dma_coherent  = PLATFORM_PCIE_DEV22_DMA_COHERENT,
    .device[22].p2p_support   = PLATFORM_PCIE_DEV22_P2P_SUPPORT,
    .device[22].dma_64bit     = PLATFORM_PCIE_DEV22_DMA_64BIT,
    .device[22].behind_smmu   = PLATFORM_PCIE_DEV22_BEHIND_SMMU,
    .device[22].atc_present   = PLATFORM_PCIE_DEV22_ATC_SUPPORT,

    .device[23].class_code    = PLATFORM_PCIE_DEV23_CLASSCODE,
    .device[23].vendor_id     = PLATFORM_PCIE_DEV23_VENDOR_ID,
    .device[23].device_id     = PLATFORM_PCIE_DEV23_DEV_ID,
    .device[23].bus           = PLATFORM_PCIE_DEV23_BUS_NUM,
    .device[23].dev           = PLATFORM_PCIE_DEV23_DEV_NUM,
    .device[23].func          = PLATFORM_PCIE_DEV23_FUNC_NUM,
    .device[23].seg           = PLATFORM_PCIE_DEV23_SEG_NUM,
    .device[23].dma_support   = PLATFORM_PCIE_DEV23_DMA_SUPPORT,
    .device[23].dma_coherent  = PLATFORM_PCIE_DEV23_DMA_COHERENT,
    .device[23].p2p_support   = PLATFORM_PCIE_DEV23_P2P_SUPPORT,
    .device[23].dma_64bit     = PLATFORM_PCIE_DEV23_DMA_64BIT,
    .device[23].behind_smmu   = PLATFORM_PCIE_DEV23_BEHIND_SMMU,
    .device[23].atc_present   = PLATFORM_PCIE_DEV23_ATC_SUPPORT,

    .device[24].class_code    = PLATFORM_PCIE_DEV24_CLASSCODE,
    .device[24].vendor_id     = PLATFORM_PCIE_DEV24_VENDOR_ID,
    .device[24].device_id     = PLATFORM_PCIE_DEV24_DEV_ID,
    .device[24].bus           = PLATFORM_PCIE_DEV24_BUS_NUM,
    .device[24].dev           = PLATFORM_PCIE_DEV24_DEV_NUM,
    .device[24].func          = PLATFORM_PCIE_DEV24_FUNC_NUM,
    .device[24].seg           = PLATFORM_PCIE_DEV24_SEG_NUM,
    .device[24].dma_support   = PLATFORM_PCIE_DEV24_DMA_SUPPORT,
    .device[24].dma_coherent  = PLATFORM_PCIE_DEV24_DMA_COHERENT,
    .device[24].p2p_support   = PLATFORM_PCIE_DEV24_P2P_SUPPORT,
    .device[24].dma_64bit     = PLATFORM_PCIE_DEV24_DMA_64BIT,
    .device[24].behind_smmu   = PLATFORM_PCIE_DEV24_BEHIND_SMMU,
    .device[24].atc_present   = PLATFORM_PCIE_DEV24_ATC_SUPPORT,

    .device[25].class_code    = PLATFORM_PCIE_DEV25_CLASSCODE,
    .device[25].vendor_id     = PLATFORM_PCIE_DEV25_VENDOR_ID,
    .device[25].device_id     = PLATFORM_PCIE_DEV25_DEV_ID,
    .device[25].bus           = PLATFORM_PCIE_DEV25_BUS_NUM,
    .device[25].dev           = PLATFORM_PCIE_DEV25_DEV_NUM,
    .device[25].func          = PLATFORM_PCIE_DEV25_FUNC_NUM,
    .device[25].seg           = PLATFORM_PCIE_DEV25_SEG_NUM,
    .device[25].dma_support   = PLATFORM_PCIE_DEV25_DMA_SUPPORT,
    .device[25].dma_coherent  = PLATFORM_PCIE_DEV25_DMA_COHERENT,
    .device[25].p2p_support   = PLATFORM_PCIE_DEV25_P2P_SUPPORT,
    .device[25].dma_64bit     = PLATFORM_PCIE_DEV25_DMA_64BIT,
    .device[25].behind_smmu   = PLATFORM_PCIE_DEV25_BEHIND_SMMU,
    .device[25].atc_present   = PLATFORM_PCIE_DEV25_ATC_SUPPORT,

    .device[26].class_code    = PLATFORM_PCIE_DEV26_CLASSCODE,
    .device[26].vendor_id     = PLATFORM_PCIE_DEV26_VENDOR_ID,
    .device[26].device_id     = PLATFORM_PCIE_DEV26_DEV_ID,
    .device[26].bus           = PLATFORM_PCIE_DEV26_BUS_NUM,
    .device[26].dev           = PLATFORM_PCIE_DEV26_DEV_NUM,
    .device[26].func          = PLATFORM_PCIE_DEV26_FUNC_NUM,
    .device[26].seg           = PLATFORM_PCIE_DEV26_SEG_NUM,
    .device[26].dma_support   = PLATFORM_PCIE_DEV26_DMA_SUPPORT,
    .device[26].dma_coherent  = PLATFORM_PCIE_DEV26_DMA_COHERENT,
    .device[26].p2p_support   = PLATFORM_PCIE_DEV26_P2P_SUPPORT,
    .device[26].dma_64bit     = PLATFORM_PCIE_DEV26_DMA_64BIT,
    .device[26].behind_smmu   = PLATFORM_PCIE_DEV26_BEHIND_SMMU,
    .device[26].atc_present   = PLATFORM_PCIE_DEV26_ATC_SUPPORT,

    .device[27].class_code    = PLATFORM_PCIE_DEV27_CLASSCODE,
    .device[27].vendor_id     = PLATFORM_PCIE_DEV27_VENDOR_ID,
    .device[27].device_id     = PLATFORM_PCIE_DEV27_DEV_ID,
    .device[27].bus           = PLATFORM_PCIE_DEV27_BUS_NUM,
    .device[27].dev           = PLATFORM_PCIE_DEV27_DEV_NUM,
    .device[27].func          = PLATFORM_PCIE_DEV27_FUNC_NUM,
    .device[27].seg           = PLATFORM_PCIE_DEV27_SEG_NUM,
    .device[27].dma_support   = PLATFORM_PCIE_DEV27_DMA_SUPPORT,
    .device[27].dma_coherent  = PLATFORM_PCIE_DEV27_DMA_COHERENT,
    .device[27].p2p_support   = PLATFORM_PCIE_DEV27_P2P_SUPPORT,
    .device[27].dma_64bit     = PLATFORM_PCIE_DEV27_DMA_64BIT,
    .device[27].behind_smmu   = PLATFORM_PCIE_DEV27_BEHIND_SMMU,
    .device[27].atc_present   = PLATFORM_PCIE_DEV27_ATC_SUPPORT,

    .device[28].class_code    = PLATFORM_PCIE_DEV28_CLASSCODE,
    .device[28].vendor_id     = PLATFORM_PCIE_DEV28_VENDOR_ID,
    .device[28].device_id     = PLATFORM_PCIE_DEV28_DEV_ID,
    .device[28].bus           = PLATFORM_PCIE_DEV28_BUS_NUM,
    .device[28].dev           = PLATFORM_PCIE_DEV28_DEV_NUM,
    .device[28].func          = PLATFORM_PCIE_DEV28_FUNC_NUM,
    .device[28].seg           = PLATFORM_PCIE_DEV28_SEG_NUM,
    .device[28].dma_support   = PLATFORM_PCIE_DEV28_DMA_SUPPORT,
    .device[28].dma_coherent  = PLATFORM_PCIE_DEV28_DMA_COHERENT,
    .device[28].p2p_support   = PLATFORM_PCIE_DEV28_P2P_SUPPORT,
    .device[28].dma_64bit     = PLATFORM_PCIE_DEV28_DMA_64BIT,
    .device[28].behind_smmu   = PLATFORM_PCIE_DEV28_BEHIND_SMMU,
    .device[28].atc_present   = PLATFORM_PCIE_DEV28_ATC_SUPPORT,

    .device[29].class_code    = PLATFORM_PCIE_DEV29_CLASSCODE,
    .device[29].vendor_id     = PLATFORM_PCIE_DEV29_VENDOR_ID,
    .device[29].device_id     = PLATFORM_PCIE_DEV29_DEV_ID,
    .device[29].bus           = PLATFORM_PCIE_DEV29_BUS_NUM,
    .device[29].dev           = PLATFORM_PCIE_DEV29_DEV_NUM,
    .device[29].func          = PLATFORM_PCIE_DEV29_FUNC_NUM,
    .device[29].seg           = PLATFORM_PCIE_DEV29_SEG_NUM,
    .device[29].dma_support   = PLATFORM_PCIE_DEV29_DMA_SUPPORT,
    .device[29].dma_coherent  = PLATFORM_PCIE_DEV29_DMA_COHERENT,
    .device[29].p2p_support   = PLATFORM_PCIE_DEV29_P2P_SUPPORT,
    .device[29].dma_64bit     = PLATFORM_PCIE_DEV29_DMA_64BIT,
    .device[29].behind_smmu   = PLATFORM_PCIE_DEV29_BEHIND_SMMU,
    .device[29].atc_present   = PLATFORM_PCIE_DEV29_ATC_SUPPORT,

    .device[30].class_code    = PLATFORM_PCIE_DEV30_CLASSCODE,
    .device[30].vendor_id     = PLATFORM_PCIE_DEV30_VENDOR_ID,
    .device[30].device_id     = PLATFORM_PCIE_DEV30_DEV_ID,
    .device[30].bus           = PLATFORM_PCIE_DEV30_BUS_NUM,
    .device[30].dev           = PLATFORM_PCIE_DEV30_DEV_NUM,
    .device[30].func          = PLATFORM_PCIE_DEV30_FUNC_NUM,
    .device[30].seg           = PLATFORM_PCIE_DEV30_SEG_NUM,
    .device[30].dma_support   = PLATFORM_PCIE_DEV30_DMA_SUPPORT,
    .device[30].dma_coherent  = PLATFORM_PCIE_DEV30_DMA_COHERENT,
    .device[30].p2p_support   = PLATFORM_PCIE_DEV30_P2P_SUPPORT,
    .device[30].dma_64bit     = PLATFORM_PCIE_DEV30_DMA_64BIT,
    .device[30].behind_smmu   = PLATFORM_PCIE_DEV30_BEHIND_SMMU,
    .device[30].atc_present   = PLATFORM_PCIE_DEV30_ATC_SUPPORT,

    .device[31].class_code    = PLATFORM_PCIE_DEV31_CLASSCODE,
    .device[31].vendor_id     = PLATFORM_PCIE_DEV31_VENDOR_ID,
    .device[31].device_id     = PLATFORM_PCIE_DEV31_DEV_ID,
    .device[31].bus           = PLATFORM_PCIE_DEV31_BUS_NUM,
    .device[31].dev           = PLATFORM_PCIE_DEV31_DEV_NUM,
    .device[31].func          = PLATFORM_PCIE_DEV31_FUNC_NUM,
    .device[31].seg           = PLATFORM_PCIE_DEV31_SEG_NUM,
    .device[31].dma_support   = PLATFORM_PCIE_DEV31_DMA_SUPPORT,
    .device[31].dma_coherent  = PLATFORM_PCIE_DEV31_DMA_COHERENT,
    .device[31].p2p_support   = PLATFORM_PCIE_DEV31_P2P_SUPPORT,
    .device[31].dma_64bit     = PLATFORM_PCIE_DEV31_DMA_64BIT,
    .device[31].behind_smmu   = PLATFORM_PCIE_DEV31_BEHIND_SMMU,
    .device[31].atc_present   = PLATFORM_PCIE_DEV31_ATC_SUPPORT,

    .device[32].class_code    = PLATFORM_PCIE_DEV32_CLASSCODE,
    .device[32].vendor_id     = PLATFORM_PCIE_DEV32_VENDOR_ID,
    .device[32].device_id     = PLATFORM_PCIE_DEV32_DEV_ID,
    .device[32].bus           = PLATFORM_PCIE_DEV32_BUS_NUM,
    .device[32].dev           = PLATFORM_PCIE_DEV32_DEV_NUM,
    .device[32].func          = PLATFORM_PCIE_DEV32_FUNC_NUM,
    .device[32].seg           = PLATFORM_PCIE_DEV32_SEG_NUM,
    .device[32].dma_support   = PLATFORM_PCIE_DEV32_DMA_SUPPORT,
    .device[32].dma_coherent  = PLATFORM_PCIE_DEV32_DMA_COHERENT,
    .device[32].p2p_support   = PLATFORM_PCIE_DEV32_P2P_SUPPORT,
    .device[32].dma_64bit     = PLATFORM_PCIE_DEV32_DMA_64BIT,
    .device[32].behind_smmu   = PLATFORM_PCIE_DEV32_BEHIND_SMMU,
    .device[32].atc_present   = PLATFORM_PCIE_DEV32_ATC_SUPPORT,

    .device[33].class_code    = PLATFORM_PCIE_DEV33_CLASSCODE,
    .device[33].vendor_id     = PLATFORM_PCIE_DEV33_VENDOR_ID,
    .device[33].device_id     = PLATFORM_PCIE_DEV33_DEV_ID,
    .device[33].bus           = PLATFORM_PCIE_DEV33_BUS_NUM,
    .device[33].dev           = PLATFORM_PCIE_DEV33_DEV_NUM,
    .device[33].func          = PLATFORM_PCIE_DEV33_FUNC_NUM,
    .device[33].seg           = PLATFORM_PCIE_DEV33_SEG_NUM,
    .device[33].dma_support   = PLATFORM_PCIE_DEV33_DMA_SUPPORT,
    .device[33].dma_coherent  = PLATFORM_PCIE_DEV33_DMA_COHERENT,
    .device[33].p2p_support   = PLATFORM_PCIE_DEV33_P2P_SUPPORT,
    .device[33].dma_64bit     = PLATFORM_PCIE_DEV33_DMA_64BIT,
    .device[33].behind_smmu   = PLATFORM_PCIE_DEV33_BEHIND_SMMU,
    .device[33].atc_present   = PLATFORM_PCIE_DEV33_ATC_SUPPORT,

    .device[34].class_code    = PLATFORM_PCIE_DEV34_CLASSCODE,
    .device[34].vendor_id     = PLATFORM_PCIE_DEV34_VENDOR_ID,
    .device[34].device_id     = PLATFORM_PCIE_DEV34_DEV_ID,
    .device[34].bus           = PLATFORM_PCIE_DEV34_BUS_NUM,
    .device[34].dev           = PLATFORM_PCIE_DEV34_DEV_NUM,
    .device[34].func          = PLATFORM_PCIE_DEV34_FUNC_NUM,
    .device[34].seg           = PLATFORM_PCIE_DEV34_SEG_NUM,
    .device[34].dma_support   = PLATFORM_PCIE_DEV34_DMA_SUPPORT,
    .device[34].dma_coherent  = PLATFORM_PCIE_DEV34_DMA_COHERENT,
    .device[34].p2p_support   = PLATFORM_PCIE_DEV34_P2P_SUPPORT,
    .device[34].dma_64bit     = PLATFORM_PCIE_DEV34_DMA_64BIT,
    .device[34].behind_smmu   = PLATFORM_PCIE_DEV34_BEHIND_SMMU,
    .device[34].atc_present   = PLATFORM_PCIE_DEV34_ATC_SUPPORT,

    .device[35].class_code    = PLATFORM_PCIE_DEV35_CLASSCODE,
    .device[35].vendor_id     = PLATFORM_PCIE_DEV35_VENDOR_ID,
    .device[35].device_id     = PLATFORM_PCIE_DEV35_DEV_ID,
    .device[35].bus           = PLATFORM_PCIE_DEV35_BUS_NUM,
    .device[35].dev           = PLATFORM_PCIE_DEV35_DEV_NUM,
    .device[35].func          = PLATFORM_PCIE_DEV35_FUNC_NUM,
    .device[35].seg           = PLATFORM_PCIE_DEV35_SEG_NUM,
    .device[35].dma_support   = PLATFORM_PCIE_DEV35_DMA_SUPPORT,
    .device[35].dma_coherent  = PLATFORM_PCIE_DEV35_DMA_COHERENT,
    .device[35].p2p_support   = PLATFORM_PCIE_DEV35_P2P_SUPPORT,
    .device[35].dma_64bit     = PLATFORM_PCIE_DEV35_DMA_64BIT,
    .device[35].behind_smmu   = PLATFORM_PCIE_DEV35_BEHIND_SMMU,
    .device[35].atc_present   = PLATFORM_PCIE_DEV35_ATC_SUPPORT,

    .device[36].class_code    = PLATFORM_PCIE_DEV36_CLASSCODE,
    .device[36].vendor_id     = PLATFORM_PCIE_DEV36_VENDOR_ID,
    .device[36].device_id     = PLATFORM_PCIE_DEV36_DEV_ID,
    .device[36].bus           = PLATFORM_PCIE_DEV36_BUS_NUM,
    .device[36].dev           = PLATFORM_PCIE_DEV36_DEV_NUM,
    .device[36].func          = PLATFORM_PCIE_DEV36_FUNC_NUM,
    .device[36].seg           = PLATFORM_PCIE_DEV36_SEG_NUM,
    .device[36].dma_support   = PLATFORM_PCIE_DEV36_DMA_SUPPORT,
    .device[36].dma_coherent  = PLATFORM_PCIE_DEV36_DMA_COHERENT,
    .device[36].p2p_support   = PLATFORM_PCIE_DEV36_P2P_SUPPORT,
    .device[36].dma_64bit     = PLATFORM_PCIE_DEV36_DMA_64BIT,
    .device[36].behind_smmu   = PLATFORM_PCIE_DEV36_BEHIND_SMMU,
    .device[36].atc_present   = PLATFORM_PCIE_DEV36_ATC_SUPPORT,

    .device[37].class_code    = PLATFORM_PCIE_DEV37_CLASSCODE,
    .device[37].vendor_id     = PLATFORM_PCIE_DEV37_VENDOR_ID,
    .device[37].device_id     = PLATFORM_PCIE_DEV37_DEV_ID,
    .device[37].bus           = PLATFORM_PCIE_DEV37_BUS_NUM,
    .device[37].dev           = PLATFORM_PCIE_DEV37_DEV_NUM,
    .device[37].func          = PLATFORM_PCIE_DEV37_FUNC_NUM,
    .device[37].seg           = PLATFORM_PCIE_DEV37_SEG_NUM,
    .device[37].dma_support   = PLATFORM_PCIE_DEV37_DMA_SUPPORT,
    .device[37].dma_coherent  = PLATFORM_PCIE_DEV37_DMA_COHERENT,
    .device[37].p2p_support   = PLATFORM_PCIE_DEV37_P2P_SUPPORT,
    .device[37].dma_64bit     = PLATFORM_PCIE_DEV37_DMA_64BIT,
    .device[37].behind_smmu   = PLATFORM_PCIE_DEV37_BEHIND_SMMU,
    .device[37].atc_present   = PLATFORM_PCIE_DEV37_ATC_SUPPORT
