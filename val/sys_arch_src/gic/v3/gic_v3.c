...
#include "include/rme_acs_gic.h"
#include "include/rme_acs_gic_support.h"
#include "include/rme_acs_pe.h"
#include "gic_v3.h"
#include "gic.h"
#include "rme_exception.h"
...
v3_Init(void)
{
  ...
  if (val_rme_gic_espi_support() || val_rme_gic_eppi_support())
    v3_extended_init();
