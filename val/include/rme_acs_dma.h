...
#ifndef __RME_ACS_DMA_H__
#define __RME_ACS_DMA_H__
...
void val_dma_mem_free(void *buffer, dma_addr_t mem_dma, uint32_t size,
		      uint32_t dev_index, uint32_t flags);

void val_dma_free_info_table(void);


#endif // __RME_ACS_DMA_H__
