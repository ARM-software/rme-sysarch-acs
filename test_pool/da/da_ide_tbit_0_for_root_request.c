...
#define TEST_NAME "da_ide_tbit_0_for_root_request"
#define TEST_DESC  "Check IDE-Tbit == 0 for outgoing Root request          "
...
uint32_t
da_ide_tbit_0_for_root_request_entry(uint32_t num_pe)
{
