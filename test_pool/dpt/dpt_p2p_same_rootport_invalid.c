...
#define TEST_NAME  "dpt_p2p_same_rootport_invalid"
...
free_mem:
      ...
      {
          val_print(ACS_PRINT_ERR, " free_mem: DPT entry add failure %4x", instance);
          test_fail++;
          continue;
      }
      ...
      if (val_dpt_invalidate_all(((uint64_t)(master.smmu_index))))
      {
          val_print(ACS_PRINT_ERR, " free_mem: DPT invalidate failure %4x", instance);
          test_fail++;
          continue;
      }
